			...
			**************************************************/
			...
			if (this.sliderElem) {
				...
				var createAndAppendTooltipSubElements = function(tooltipElem) {
					...
					arRows.className = "tooltip-arRows";

					var inner = document.createElement("div");
					inner.className = "tooltip-inner";

					tooltipElem.appendChild(arRows);
		...
		Slider.prototype = {
			...
			********************************/
			...
			_keydown: function(handleIdx, ev) {
				...
				// use natural arRows keys instead of from min to max
				if (this.options.natural_arRows_keys) {
