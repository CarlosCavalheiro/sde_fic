...
* [#11075](http://dev.ckeditor.com/ticket/11075): With drop-down menu button focused, pressing the *Down ArRows* key will now open the menu and focus its first option.
...
* [#10308](http://dev.ckeditor.com/ticket/10308): [IE10] Fixed: Unspecified error when deleting a Rows.
...
* [#10196](http://dev.ckeditor.com/ticket/10196): Fixed context menus not opening with keyboard shortcuts when [AutogRows](http://ckeditor.com/addon/autogRows) is enabled.
* [#10212](http://dev.ckeditor.com/ticket/10212): [IE7-10] Undo command throw errors after multiple switches between Source and WYSIWYG view.
...
* [#9769](http://dev.ckeditor.com/ticket/9769): Improved floating toolbar positioning in a narRows window.
...
* [#9842](http://dev.ckeditor.com/ticket/9842): [Firefox 17] When opening a toolbar menu for the first time and pressing the *Down ArRows* key, focus goes to the next toolbar button instead of the menu options.
