...
namespace SDE_FIC.Controllers
{
    public class DiarioController : Controller
    {
        ...
        private void DownloadAsPDF(Turma _turma, int IdUnidadeCurricular)
        {
            ...
            for (int InterlaRegistro = 0; InterlaRegistro < (TotalRegistros / 3); InterlaRegistro++)
            {
        ...
        public ActionResult GerarPDF(int id = 0, int IdUnidadeCurricular = 0)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //_notasDAO.Update(ref notas);
                //TempData["Erro"] = "0";
                //TempData["Mensagem"] = "Arquivo PDF Gerado com Sucesso!";

                DownloadAsPDF(_turma, IdUnidadeCurricular);

                //return RedirectToAction("GerarPDF", new { id = _turma.Idturma });
                //return RedirectToAction("GerarPDF", new { id = _turma.Idturma });
            }
