...
(function (window, undefined) {
        ...
        for (; i < l; i++) {
            ...
            if (elem || elem === 0) {
                ...
                if (jQuery.type(elem) === "object") {
                    // Support: QtWebKit
                    // jQuery.merge because core_push.apply(_, arraylike) throw
    ...
    jQuery.error = function (msg) {
        /// <summary>
        ///     Takes a string and throw an exception containing it.
        /// </summary>
    ...
    jQuery.prototype.appendTo = function (selector) {
        ...
        for (; i <= last; i++) {
            ...
            // Support: QtWebKit
            // .get() because core_push.apply(_, arraylike) throw
